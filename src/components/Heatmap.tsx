...
export default function Heatmap() {
  ...
  const { cells, totalSolvedIn90 } = useMemo(() => {
    ...
    sessions.forEach((session: { date?: string; attempted?: number }) => {
  ...
  const handleMouseEnter = (e: React.MouseEvent<SVGRectElement>, cell: HeatmapCell) => {
    ...
    <div style={styles.card} className="card">
      <div style={styles.header}>
        ...
        <div style={styles.legend}>
          ...
          {(['#161b22', 'rgba(99, 102, 241, 0.15)', 'rgba(99, 102, 241, 0.35)', 'rgba(99, 102, 241, 0.6)', 'var(--accent)'] as const).map((c, i) => (
