...
export default function AnimationPlayer({ path, title, description, onClose }) {
    ...
    <div style={styles.container} className="card glass">
      ...
      <div style={styles.videoWrapper}>
        {error ? (
          <div style={styles.errorBox}>
            ...
            <p style={{ margin: '8px 0 0 0', fontSize: '12px' }}>Failed to load native webm animation.</p>
      ...
      <div style={styles.controlsBar}>
        ...
        <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
          <ClockIcon size={12} color="var(--text-secondary)" style={{ marginRight: '4px' }} />
...
const WarningIcon = ({ size = 20, color = 'var(--danger)' }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
