            ...
            {Object.entries(scaffoldL1.options).map(([key, val]) => {
              ...
              return (
                <OptionButton
                  ...
                  isCorrect={scaffoldL1.answer === key}
                  isWrong={selectedOption === key && scaffoldL1.answer !== key}
    ...
    return (
      <div className="bg-surface border border-border rounded-xl p-6 animate-fade-in">
        <h3 className="text-lg font-semibold text-accent mb-2">
          Understanding: {(question as Record<string, string> | undefined)?.primaryConcept}
        </h3>
