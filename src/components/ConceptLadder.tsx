...
interface ConceptLadderProps {
  ladderData: { ladder: Array<{ concept: string; explanation: string; example?: string; videoSearchQuery?: string }> };
  stuckConcept: string;
  onCompleteLadder: () => void;
  onNextQuestion?: () => void;
}
...
export default function ConceptLadder({
  ...
  const handleWatchVideo = (rung: RungItem) => {
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.stepperContainer}>
        {ladder.map((rung: RungItem, index: number) => {
                  ...
                  <AnimatePresence initial={false}>
                    {isActive && (
                      <motion.div
                        ...
                        style={styles.rungContent as React.CSSProperties}
                      >
